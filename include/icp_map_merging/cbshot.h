...
public :
    ...
    pcl::PointCloud<pcl::PointXYZI> cloud1_keypoints, cloud2_keypoints;
    ...
    void calculate_normals_map ( float radius )
    {
        ...
        normalEstimation.setInputCloud(cloud2.makeShared());
        std::cout << "Computing Map normal" << std::endl;
        normalEstimation.compute(cloud2_normals);
    }

    void calculate_normals_cloud ( float radius )
    {
        // Estimate the normals.
        pcl::NormalEstimationOMP<pcl::PointXYZI, pcl::Normal> normalEstimation;
        normalEstimation.setRadiusSearch(radius);
        ...
        normalEstimation.setInputCloud(cloud1.makeShared());
        std::cout << "Computing cloud normal" << std::endl;
        normalEstimation.compute(cloud1_normals);
    }
    ...
    void  calculate_voxel_grid_map ( float leaf_size )
    {
        // Find Keypoints on the input cloud
        pcl::VoxelGrid<pcl::PointXYZI> voxel_grid;
        voxel_grid.setLeafSize(leaf_size, leaf_size, leaf_size);
    ...
    void  calculate_voxel_grid_cloud ( float leaf_size )
    {
        // Find Keypoints on the input cloud
        pcl::VoxelGrid<pcl::PointXYZI> voxel_grid;
        voxel_grid.setLeafSize(leaf_size, leaf_size, leaf_size);
    ...
    void calculate_SHOT ( float radius )
    {
        ...
        std::cout << "Computing C1 SHOT" << std::endl;
        ...
        std::cout << "Computing C2 SHOT" << std::endl;
        shot.compute(cloud2_shot);
        

    }

    void calculate_SHOT_map ( float radius )
    {
    ...
    void calculate_SHOT_cloud ( float radius )
    {
